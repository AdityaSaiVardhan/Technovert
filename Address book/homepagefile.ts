...
var contact:obj={"contact_name_field":"", 
"contact_email_field": "", 
...
function inputsValidations(input:JQuery.KeyUpEvent)
{
...
function showaddressbook(){
    var contact_preview=(<HTMLElement>document.getElementById('contactPreview'));
