...
var contactOb:obj_created={"contact_name_field":"", 
    "contact_email_field": "", 
...
function inputs(input:JQuery.KeyUpEvent):void
{
...
function add_book(event:JQuery.ClickEvent):void{
...
function showaddbook():void{
    var contact_preview:HTMLInputElement=(document.getElementById("contactPreview")as HTMLInputElement);
