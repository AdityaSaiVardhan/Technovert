...
var contactOb:obj={"contact_name_field":"", 
    "contact_email_field": "", 
...
function inputs(input:JQuery.KeyUpEvent)
{
...
function add_book(event:JQuery.ClickEvent){
...
function showaddbook(){
    var contact_preview=(document.getElementById("contactPreview")as HTMLInputElement);
