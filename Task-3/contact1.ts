function appendfun():void{
    var state=(<HTMLInputElement>document.getElementById("contact_state")).value;
	var promo:string;
	if(state=="")
	{
		(<HTMLInputElement>document.getElementById("contactPromotionCode")).value=""
	}
	else{
		promo=state.concat('-PROMO');
		(<HTMLInputElement>document.getElementById("contactPromotionCode")).value=promo;
	}
}

function genderFun(input:HTMLInputElement):void{
	if(input.id=='male'){
		alert('Hello sir!');
	}
...
function showemptymsg(error_id:string,string:string):void
{
...
function showerror(error_id:string,string:string):void{
   (<HTMLDivElement>document.getElementById(error_id)).style.display="inline";
   (<HTMLDivElement>document.getElementById(error_id)).innerHTML="Invalid".concat(" ",string);  
}

function hideerror(error_id:string):void{
...
function clearform(event:any):void {  
   var ans=confirm("Are you sure?");
	var inputFields = (<any>document.getElementsByClassName("input_textbox"));
	if(ans){
