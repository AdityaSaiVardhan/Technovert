$('#contact_state').on("change",function(input:any){
...
$('#male,#female').on("click",function gender(input:any){
...
$('#contact_name_field').on("keyup",function(input:any)
{
...
$('#contactform').on("keyup",function(input:any)
{
...
$('#contact_phone_number_field').on("keyup",function(input:any)
{
   var digits=/[^0-9]/gi;
