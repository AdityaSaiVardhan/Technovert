$('#contact_state').on("change",function(input:JQuery.ChangeEvent){
...
$('#male,#female').on("click",function gender(input:JQuery.ClickEvent){
...
$('#contact_name_field').on("keyup",function(input:JQuery.KeyUpEvent)
{
...
$('#contactform').on("keyup",function(input:JQuery.KeyUpEvent)
{
...
$('#contact_phone_number_field').on("keyup",function(input:JQuery.KeyUpEvent)
{
...
$('#reset').on("click",function(event:JQuery.ClickEvent) {  
